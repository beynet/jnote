...
$JAVA_HOME/bin/javapackager -deploy -native image -srcdir target -srcfiles jnote-1.0.11-jar-with-dependencies.jar -appclass org.beynet.jnote.gui.Main -name jnote -outdir ./target/app -outfile jnote && \
cd target/app/ && \
